...
function createRule(breakpoint, prefix, options, spacer) {
    var rule = (spacer || '') + '[class*="' + options.columnPrefix + '-"]:not(.grid-no-gutter), .' + prefix + 'wrapper:not(.grid-no-gutter), .' + prefix + 'wrapper-fluid:not(.grid-no-gutter) {\n';
